...
\begin{figure}
  \centering
  \includegraphics[width=0.75\columnwidth]{hvm_setup_with_blue.png}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{hvm_image_formation_new}
...
As the incident illumination propagates through the sample, scatterers
...
with the medium and the particle respectively. The infinite
