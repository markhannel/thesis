...
The image formed in the focal plane of the objective is proportional to
the sum of the electric fields squared,
\begin{eqnarray}
...
$\epsilon_0$ is the vacuum permittivity, and we've assumed the medium is non-magnetic ($\mu_r=1$).
