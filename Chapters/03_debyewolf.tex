...
\begin{figure}
  ...
  \caption{The two spherical geometries necessary for our description. The un-primed coordinates
    ...
    $\theta_{\text{img}}$ maximal half-angle of the cone of light that can enter or exit the
...
pixel in the respective holograms is below the sensitivity of our camera.
...
\subsection{Fitting vector-based holograms to a scalar theory}

To systematically assess the differences in the two theories, we produce
numerous synthetic holograms over a wide range of scatterer properties.
Specifically, we generate holographic images of spherical scatterers with radii from
...
We then fit each synthetic hologram to the scalar theory as outlined
