...
\begin{figure}
  \centering
  \includegraphics[width=0.6\textwidth]{debyewolf_waterglass}
...
\begin{figure}
  \centering
  \includegraphics[width=0.75\textwidth]{debyewolf_geom}
...
\begin{equation}
  M = \frac{n \sqrt{s_x^2 + s_y^2 }}{n^{\prime} \sqrt{s_x^{\prime 2} + s_y^{\prime 2} }}.
