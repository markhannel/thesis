\chapter{Holographic characterization of imperfect colloidal spheres}
\label{ch:dimpled}

\section{Introduction}
In this chapter we call into question the assumption that the scatterer is
spherical:
how will deviations from sphericity affect our results if we model
the scatterer as a perfect sphere? We will present a series of
experimental and simulated results from fitting holographic features of
imperfect spheres with the Lorenz-Mie theory.
In so doing, we demonstrate that this technique yields similarly precise 
and meaningful results for imperfect spheres, provided that their
deviation from sphericity is not too pronounced.

\begin{figure*}[t]
  \centering
  \includegraphics[width=0.8\textwidth]{dimpled_figure1}
