...
Each holographic measurement is an estimate of a
particle's average properties during the exposure period of a
recorded video frame. Saglimbeni, \emph{et al.} \ref{saglimbeni16}
report \SI{4.5}{\um}
diameter polystyrene particles shrinking by \SI{0.5}{\um}
after exerting \SI{2.0}{\giga\pascal} pressures on the sample.
We expect pressure fluctuations many orders of magnitude less
such that fluctuations in the particle's radius
and refractive index are marginal compared to the precision of the
technique. 
...
Fluctuations in a particle's properties over many frames
manifest themselves as variance in the distribution of particle's
properties.
%Micrometer-sized particles with a Young's modulus around
%5\SI{1.0}{\giga\pascal} experiencing forces as 
