...
The time cost of this powerful technique is the computational burden of
...
fit Eq.~\eqref{eq:gen_norm} through \eqref{eq:bn} to measured holograms using $a_p$, $n_p$
...
Here, we instead use Eq.~\eqref{eq:gen_norm} through \eqref{eq:bn} to train
