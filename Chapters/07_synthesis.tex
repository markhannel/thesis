...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{synthesis_example_poiseuille_fit}
...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{synthesis_sem_stir_analysis}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\columnwidth]{synthesis_abbe_madness}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\columnwidth]{synthesis_orthogonal_vs_hpc}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\columnwidth]{synthesis_longitudinal_summary.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\columnwidth]{synthesis_longitudinal_np.png}
